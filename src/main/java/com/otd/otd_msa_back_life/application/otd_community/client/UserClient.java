package com.otd.otd_msa_back_life.application.otd_community.client;
...
@FeignClient(
        ...
        configuration = com.otd.otd_msa_back_life.application.otd_community.config.FeignConfig.class
)
